...
const OrderSchema = new mongoose.Schema({
  ...
  paymentStatus: { type: String, default: "pending", enum: ["pending", "paid", "refunded", "not_applicable"] },
  escrowStatus: { type: String, default: "awaiting_payment", enum: ["awaiting_payment", "holding", "awaiting_fulfilment", "shipped", "meetup_ready", "delivered", "released", "disputed", "open"] },
