  ...
  try {
    ...
    const safe = items.map((o) => {
      if (!o.contactReleased) {
        // ensure seller never receives buyer contact/address until buyer releases
        delete o.contact;
        delete o.address;
      }
      return o;
 ...
 * Supports BOTH:
 *  - POST /api/orders/release-contact/:id        (what your base.js currently uses)
 *  - POST /api/orders/:id/release-contact        (older builds)
 */
